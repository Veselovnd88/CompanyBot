...
class AddManagerByAdminMessageHandlerTest {
    ...
    void init(){
        ...
        when(divisionKeyboardUtils.divisionKeyboard()).thenReturn(new InlineKeyboardMarkup());
    }
    ...
    void forwardedMessageTest(){
        ...
        verify(divisionKeyboardUtils).divisionKeyboard();
    ...
    void forwardedMessageNoForwardedTest(){
        ...
        verify(divisionKeyboardUtils,never()).divisionKeyboard();
